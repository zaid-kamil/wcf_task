...
public class CandidateMain {
	...
	public String addCandidate(CandidateBean studBean) {
		...
		try {
			...
			result = actionState.equalsIgnoreCase("SUCCESS") ? studBean.getId() + ":" + studBean.getResult()
					: actionState;
		} catch (WrongDataException e) {
			return new WrongDataException().toString();
		}
		return result;
	}

	public ArrayList<CandidateBean> displayAll(String criteria) {
		List<String> criteriaList = Arrays.asList("ALL", "PASS", "FAIL");
