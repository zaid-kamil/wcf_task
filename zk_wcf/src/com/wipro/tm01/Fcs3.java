...
/*
 * Write a program to check if the program has 
 * received command line arguments or not.
 * If the program has not received arguments 
 * then print "No Values", else print all the 
